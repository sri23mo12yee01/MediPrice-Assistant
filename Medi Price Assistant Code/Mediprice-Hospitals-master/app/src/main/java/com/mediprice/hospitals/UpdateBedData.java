...
public class UpdateBedData extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dbHospitalId= SpHelper.getRoll(this).getId();
        db.collection("hospital").document(dbHospitalId).get()
                .addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                        if(task.isSuccessful()){
                            ...
                            Toast.makeText(UpdateBedData.this,"Failed to load bed data",Toast.LENGTH_LONG).show();
                        }
                    }
    ...
    private void updateValue() {
        ...
        if (!hasValidationErrors(vacant,o2,nonO2,icu,ventilator)) {
            ...
            db.collection("hospital").document(dbHospitalId)
                    .update(
                            "vacant", m.getVacant(),
                            "o2",m.getO2(),
                            "nonO2",m.getNonO2(),
                    ...
                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                        ...
                        public void onSuccess(Void aVoid) {
                            ...
                            UpdateBedData.this.onBackPressed();
                        }
                    });
        }
