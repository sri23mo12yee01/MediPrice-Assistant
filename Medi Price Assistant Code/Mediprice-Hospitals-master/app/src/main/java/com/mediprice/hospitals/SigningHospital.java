...
public class SigningHospital extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        totalBeds = findViewById(R.id.facility);
        ...
        mAuth.createUserWithEmailAndPassword(email, pwd).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if (task.isSuccessful()) {
                    registerUser();
                    Toast.makeText(SigningHospital.this, "Hospital registered successfully", Toast.LENGTH_SHORT).show();
                    startActivity(hospitaldash);
                } else {
                    Toast.makeText(SigningHospital.this, "Error" + task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                }
            }
        });
        //clearData();
