...
import com.mediprice.hospitals.Helpers.CoreHelper;
import com.mediprice.hospitals.Helpers.CustomModel;
import com.mediprice.hospitals.Helpers.ImagesAdapter;
...
public class AddPatient extends AppCompatActivity {
    ...
    int counter;
    EditText patientName,patientAge,phoneNumber,patientGender,patientArea;//patientRelation
    Button requestBtn,btnPickImages;
    FirebaseFirestore db;
    FirebaseAuth mAuth = FirebaseAuth.getInstance();
    private final String hospitalId = mAuth.getCurrentUser().getUid();
    ...
    private void clearData() {
      ...
      //  patientRelation.getText().clear();
        ...
        //spinnerTime.setAdapter(ArrayAdapter.createFromResource(this, com.kamlesh.covid.R.array.time_array, android.R.layout.simple_spinner_dropdown_item));
